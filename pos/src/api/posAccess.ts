...
export type POSPermissionKey = 'sales' | 'bills' | 'products' | 'stock' | 'reports' | 'settings' | 'discounts' | 'void_sales' | 'stock_adjust' | 'product_pricing' | 'report_export' | 'member_create';
