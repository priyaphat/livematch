...
export type POSReportPermissionKey = 'report_overview' | 'report_top_sellers' | 'report_vat' | 'report_payments' | 'report_sold_products' | 'report_purchases' | 'report_inventory' | 'report_transfers' | 'report_special';
...
export const POS_REPORT_PERMISSION_KEYS: POSReportPermissionKey[] = ['report_overview', 'report_top_sellers', 'report_vat', 'report_payments', 'report_sold_products', 'report_purchases', 'report_inventory', 'report_transfers', 'report_special'];
